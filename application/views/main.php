...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url() ?>assets/frontend/css/theme.css?v=2.0.1">
...
<body>
	...
	<!-- Call Now -->
	<a href="tel:<?php echo str_replace(' ', '', str_replace('-', '', str_replace('.', '', $company['phone_number']))) ?>" class="floating-phone-label floating-phone-label--phone"><?php echo $company['phone_number'] ?></a>
